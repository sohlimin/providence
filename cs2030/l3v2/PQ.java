...
public class PQ<E extends Comparable<? super E>> {
     ...
     *
     * @return the {@code Maybe} of the head of this queue, and the
     *         resulting priority queue after removal as a {@code Pair}
     */
    public Pair<Maybe<E>, PQ<E>> poll() {
        PQ<E> copy = new PQ<E>(this.pq);
        Maybe<E> t = Maybe.of/*Nullable*/(copy.pq.poll());
        return new Pair<Maybe<E>,PQ<E>>(t, copy);
    }
